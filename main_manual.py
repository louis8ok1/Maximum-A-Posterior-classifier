...
if __name__ =="__main__":
    ...
    #data split
    cls1_test_data,cls2_test_data = data_split(new_test_data)
    
    cls1_train_data,cls2_train_data = data_split(new_train_data)
    
    #mean vector 50*1
    mean1,mean2 = mean(cls1_train_data,cls2_train_data)
    
    #covariance matrix 50*50
    cov1,cov2 = cov(cls1_train_data,cls2_train_data)
    

    #test data predict
    test_data_predict(cls1_test_data,cls2_test_data,mean1,mean2,cov1,cov2)
    #train data predict
    test_data_predict(cls1_train_data,cls2_train_data,mean1,mean2,cov1,cov2)